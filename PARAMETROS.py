...
# --- LISTA DE ACTIVIDADES PREVENTIVAS ACTUALIZADA ---
ACTIVIDADES_PREVENTIVAS_MAP = {
    ...
    "120": "120: Vacuna COVID-19"
}

# --- MAPEO DE RESTRICCIÓN DE CÓDIGO PRESTACIONAL A CÓDIGOS DE ACTIVIDAD ---
RELACION_CODIGO_ACTIVIDADES = {
    ...
    # Fallback o valor por defecto si un código no tiene una relación explícita
